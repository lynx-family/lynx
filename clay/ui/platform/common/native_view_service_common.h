...
#ifndef CLAY_UI_PLATFORM_COMMON_PLATFORM_VIEW_SERVICE_COMMON_H_
#define CLAY_UI_PLATFORM_COMMON_PLATFORM_VIEW_SERVICE_COMMON_H_
...
#endif  // CLAY_UI_PLATFORM_COMMON_PLATFORM_VIEW_SERVICE_COMMON_H_
