...
#ifndef CLAY_UI_COMPONENT_NESTED_SCROLL_NESTED_DRAGGABLE_H_
#define CLAY_UI_COMPONENT_NESTED_SCROLL_NESTED_DRAGGABLE_H_
...
#endif  // CLAY_UI_COMPONENT_NESTED_SCROLL_NESTED_DRAGGABLE_H_
