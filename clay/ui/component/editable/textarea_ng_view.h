...
#undef UI_METHOD_LIST_DECLARATION
 ...
 private:
  ...
  FRIEND_TEST(TextAreaNGViewTest, platformHistoryActionBridge);
  FRIEND_TEST(TextAreaNGViewTest, ImmediateRedoPreservesPendingEdit);
  FRIEND_TEST(TextAreaNGViewTest, ImmediateRedoDiscardsOldBranchAfterEdit);
