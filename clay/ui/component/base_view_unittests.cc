...
TEST_F_UI(BaseViewWithChildrenTest, PaintOrder) {
  ...
  TransformValue transform3;
  transform3.stacking_z = 1.0f;
  ...
  TransformValue transform6;
  transform6.stacking_z = 1.0f;
  ...
  TransformValue transform8;
  transform8.stacking_z = 1.0f;
...
TEST_F_UI(BaseViewWithChildrenTest,
  ...
  value.visual_operations.AppendTranslate(
      {10.0f, lynx::gfx::LengthUnit::kNumber},
      {20.0f, lynx::gfx::LengthUnit::kNumber},
      {0.0f, lynx::gfx::LengthUnit::kNumber});
  value.stacking_z = 30.0f;
