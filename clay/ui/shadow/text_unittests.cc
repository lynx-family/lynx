...
TEST_F_UI(TextTest, ExistingTextsResolveFontLoadedAfterStyleUpdate) {
  ...
  auto second_text =
      std::make_shared<TextShadowNode>(owner_, std::string("text"), -1);
  ...
  LoadTestFont(family_name, [this, family_name, second_text]() {
...
TEST_F_UI(TextTest, FontCallbacksAreDeduplicatedAndCancelled) {
  ...
  LoadTestFont(family_name, [this, font_collection, family_name]() {
...
TEST_F_UI(TextTest, StaleFontLoadDoesNotOverrideCurrentFontRequest) {
  ...
  LoadTestFont(old_family, [this, old_family, current_family]() {
    EXPECT_NE(text_shadow_node_->text_style_->font_family, old_family);
    LoadTestFont(current_family, [this, current_family]() {
...
TEST_F_UI(TextTest, AsyncFallbackCompletionKeepsFontFamilyPriority) {
  ...
  LoadTestFont(fallback_family, [this, preferred_family, fallback_family]() {
    EXPECT_EQ(text_shadow_node_->text_style_->font_family, fallback_family);
    LoadTestFont(preferred_family, [this, preferred_family]() {
...
TEST_F_UI(TextTest, AsyncFallbackCannotOverrideLoadedPreferredFamily) {
  ...
  text_shadow_node_->SetFontFamily(preferred_family + ", " + fallback_family);
  LoadTestFont(preferred_family, [this, preferred_family, fallback_family]() {
    EXPECT_EQ(text_shadow_node_->text_style_->font_family, preferred_family);
    LoadTestFont(fallback_family, [this, preferred_family]() {
      EXPECT_EQ(text_shadow_node_->text_style_->font_family, preferred_family);
    });
  });
}
...
TEST_F_UI(TextTest, LoadingAssetFontPrecedesSameNamedSystemFont) {
  ...
  LoadTestFont(fallback_family, [this, font_collection, family_name,
                                 fallback_family]() {
    AsyncStart();
    font_collection->PreLoadFontOnMem(
        ui_task_runner(), nullptr, nullptr, family_name,
        {"data:font/ttf,invalid"},
        [this, font_collection, family_name, fallback_family](bool success) {
          ...
          EXPECT_EQ(text_shadow_node_->text_style_->font_family,
                    fallback_family);
          AsyncEnd();
        });
