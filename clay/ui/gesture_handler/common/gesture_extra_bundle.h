...
#ifndef CLAY_UI_GESTURE_HANDLER_COMMON_GESTURE_EXTRA_BUNDLE_H_
#define CLAY_UI_GESTURE_HANDLER_COMMON_GESTURE_EXTRA_BUNDLE_H_

namespace clay {

class GestureExtraBundle {
 public:
  GestureExtraBundle() = default;
...
#endif  // CLAY_UI_GESTURE_HANDLER_COMMON_GESTURE_EXTRA_BUNDLE_H_
