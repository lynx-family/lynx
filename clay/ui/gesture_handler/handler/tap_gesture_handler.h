...
#ifndef CLAY_UI_GESTURE_HANDLER_HANDLER_TAP_GESTURE_HANDLER_H_
#define CLAY_UI_GESTURE_HANDLER_HANDLER_TAP_GESTURE_HANDLER_H_
...
class TapGestureHandler : public BaseGestureHandler {
 public:
  TapGestureHandler(int sign, PageView* page_view,
...
#endif  // CLAY_UI_GESTURE_HANDLER_HANDLER_TAP_GESTURE_HANDLER_H_
