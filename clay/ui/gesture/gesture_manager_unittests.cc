...
TEST_F(GestureManagerTest, Exception_Test) {
  ...
  gesture_manager()->HandlePointerEvents(
      root(), CreatePointer(pointer_id, PointerEvent::EventType::kUnkownEvent));
  gesture_manager()->HandlePointerEvents(
      root(), CreatePointer(pointer_id, PointerEvent::EventType::kMoveEvent));
  gesture_manager()->HandlePointerEvents(
      root(), CreatePointer(pointer_id, PointerEvent::EventType::kUpEvent));
  gesture_manager()->HandlePointerEvents(
      root(), CreatePointer(pointer_id, PointerEvent::EventType::kDownEvent));
  gesture_manager()->HandlePointerEvents(
      root(), CreatePointer(pointer_id, PointerEvent::EventType::kUpEvent));
}
