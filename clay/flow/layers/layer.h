...
struct PrerollContext {
  ...
  // This flag will be set to true if there is an animation in the display list.
  // In such cases, the raster cache should not be enabled because the layer
  // will be subject to frequent modifications.
  bool has_dl_running_animation = false;
