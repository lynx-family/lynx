...
void ContainerLayer::PrerollChildren(PrerollContext* context,
  ...
  bool child_has_dl_running_animation = false;
  ...
  for (auto& layer : layers_) {
    ...
    context->has_dl_running_animation = false;
    ...
    child_has_drawable_image_layer =
        child_has_drawable_image_layer || context->has_drawable_image_layer;
    child_has_punch_hole_layer =
        child_has_punch_hole_layer || context->has_punch_hole_layer;
    child_has_dl_running_animation =
        child_has_dl_running_animation || context->has_dl_running_animation;
    child_has_deferred_image =
  ...
  context->has_dl_running_animation = child_has_dl_running_animation;
