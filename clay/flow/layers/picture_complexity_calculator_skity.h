...
#ifndef FLUTTER_FLOW_PICTURE_COMPLEXITY_CALCULATOR_SKITY_H_
#define FLUTTER_FLOW_PICTURE_COMPLEXITY_CALCULATOR_SKITY_H_
  ...
  class SkityReplayHelper : public skity::Canvas {
   public:
    ...
    void OnDrawImageRect(std::shared_ptr<skity::Image> image,
                         ...
                         skity::Paint const* paint) override;
    void OnDrawAtlasImage(const std::vector<uint32_t> key,
...
#endif  // FLUTTER_FLOW_PICTURE_COMPLEXITY_CALCULATOR_SKITY_H_
