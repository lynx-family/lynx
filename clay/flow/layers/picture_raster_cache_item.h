...
#ifndef FLUTTER_FLOW_LAYERS_PICTURE_RASTER_CACHE_ITEM_H_
#define FLUTTER_FLOW_LAYERS_PICTURE_RASTER_CACHE_ITEM_H_
...
class PictureRasterCacheItem : public RasterCacheItem {
 public:
  ...
  void SetHasRunningTransformAnimation(bool has_animation) {
    has_running_transform_animation_ = has_animation;
  }
...
#endif  // FLUTTER_FLOW_LAYERS_PICTURE_RASTER_CACHE_ITEM_H_
