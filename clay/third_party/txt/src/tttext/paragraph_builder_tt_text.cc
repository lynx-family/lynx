...
tttext::Style ParagraphBuilderTTText::ToTTStyle(const TextStyle& text_style) {
  tttext::Style style;
  tttext::FontStyle::Weight weight;
  switch (text_style.font_weight) {
    case FontWeight::w100:
      weight = tttext::FontStyle::Weight::kThin_Weight;
      break;
    case FontWeight::w200:
      weight = tttext::FontStyle::Weight::kExtraLight_Weight;
      break;
    case FontWeight::w300:
      weight = tttext::FontStyle::Weight::kLight_Weight;
      break;
    case FontWeight::w400:
      weight = tttext::FontStyle::Weight::kNormal_Weight;
      break;
    case FontWeight::w500:
      weight = tttext::FontStyle::Weight::kMedium_Weight;
      break;
    case FontWeight::w600:
      weight = tttext::FontStyle::Weight::kSemiBold_Weight;
      break;
    case FontWeight::w700:
      weight = tttext::FontStyle::Weight::kBold_Weight;
      break;
    case FontWeight::w800:
      weight = tttext::FontStyle::Weight::kExtraBold_Weight;
      break;
    case FontWeight::w900:
      weight = tttext::FontStyle::Weight::kBlack_Weight;
      break;
  }
  tttext::FontDescriptor fd{{text_style.font_families},
                            {weight, tttext::FontStyle::Width::kNormal_Width,
                             tttext::FontStyle::Slant::kUpright_Slant},
                            0};
