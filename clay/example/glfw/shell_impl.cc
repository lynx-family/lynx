...
clay::PointerData::Change ToPointerDataChange(ClayPointerPhase phase) {
  switch (phase) {
    case kClayPointerPhaseCancel:
      return clay::PointerData::Change::kCancel;
    case kClayPointerPhaseUp:
      return clay::PointerData::Change::kUp;
    case kClayPointerPhaseDown:
      return clay::PointerData::Change::kDown;
    case kClayPointerPhaseMove:
      return clay::PointerData::Change::kMove;
    case kClayPointerPhaseAdd:
      return clay::PointerData::Change::kAdd;
    case kClayPointerPhaseRemove:
      return clay::PointerData::Change::kRemove;
    case kClayPointerPhaseHover:
      return clay::PointerData::Change::kHover;
    case kClayPointerPhasePanZoomStart:
      return clay::PointerData::Change::kPanZoomStart;
    case kClayPointerPhasePanZoomUpdate:
      return clay::PointerData::Change::kPanZoomUpdate;
    case kClayPointerPhasePanZoomEnd:
      return clay::PointerData::Change::kPanZoomEnd;
  }
  return clay::PointerData::Change::kCancel;
}

clay::PointerData::SignalKind ToPointerDataSignalKind(
    ClayPointerSignalKind kind) {
  switch (kind) {
    case kClayPointerSignalKindNone:
      return clay::PointerData::SignalKind::kNone;
    case kClayPointerSignalKindScroll:
      return clay::PointerData::SignalKind::kScroll;
    case kClayPointerSignalKindScrollInertiaCancel:
      return clay::PointerData::SignalKind::kScrollInertiaCancel;
    case kClayPointerSignalKindScale:
      return clay::PointerData::SignalKind::kScale;
  }
  return clay::PointerData::SignalKind::kNone;
}

int64_t PointerDataButtonsForLegacyEvent(clay::PointerData::Change change) {
  switch (change) {
    ...
    case clay::PointerData::Change::kMove:
      ...
      return clay::kPointerButtonMousePrimary;
...
clay::PointerData::DeviceKind ToPointerDataKind(
    ClayPointerDeviceKind device_kind) {
  switch (device_kind) {
    case kClayPointerDeviceKindMouse:
      return clay::PointerData::DeviceKind::kMouse;
    case kClayPointerDeviceKindTouch:
      return clay::PointerData::DeviceKind::kTouch;
    case kClayPointerDeviceKindStylus:
      return clay::PointerData::DeviceKind::kStylus;
    case kClayPointerDeviceKindTrackpad:
      return clay::PointerData::DeviceKind::kTrackpad;
  }
  return clay::PointerData::DeviceKind::kMouse;
}
