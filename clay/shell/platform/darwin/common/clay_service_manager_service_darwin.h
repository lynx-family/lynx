...
#ifndef CLAY_SHELL_PLATFORM_DARWIN_COMMON_SERVICES_CLAY_SERVICE_MANAGER_SERVICE_DARWIN_H_
#define CLAY_SHELL_PLATFORM_DARWIN_COMMON_SERVICES_CLAY_SERVICE_MANAGER_SERVICE_DARWIN_H_
