...
#ifndef CLAY_GFX_SHARED_IMAGE_ANGLE_SOFTWARE_GL_IMAGE_REPRESENTATION_H_
#define CLAY_GFX_SHARED_IMAGE_ANGLE_SOFTWARE_GL_IMAGE_REPRESENTATION_H_
...
class AngleSoftwareGLImageRepresentation final : public GLImageRepresentation {
 public:
  explicit AngleSoftwareGLImageRepresentation(
      fml::RefPtr<SharedImageBacking> backing);
  ~AngleSoftwareGLImageRepresentation() override;
...
#endif  // CLAY_GFX_SHARED_IMAGE_ANGLE_SOFTWARE_GL_IMAGE_REPRESENTATION_H_
