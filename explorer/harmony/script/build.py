...
def run_gn(args, gn_out_dir, abi):
    gn_args = f'target_os="harmony" jsengine_type="quickjs" is_debug={str(args.debug).lower()} target_cpu="{get_cpu_type(abi)}" harmony_sdk_version="default" use_primjs_napi=true enable_lepusng_worklet=true build_lepus_compile=false enable_primjs_prebuilt_lib=true enable_inspector=true enable_harmony_shared=true'
    if args.dev:
