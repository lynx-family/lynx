...
def run_gn(is_debug, gn_out_dir):
    cmd = f'gn gen {gn_out_dir} --args=\'target_os="harmony" jsengine_type="quickjs" is_debug={str(is_debug).lower()} target_cpu="arm64" harmony_sdk_version="default" use_primjs_napi=true build_lepus_compile=false enable_primjs_prebuilt_lib=true enable_inspector=true enable_harmony_shared=true\' --export-compile-commands'
