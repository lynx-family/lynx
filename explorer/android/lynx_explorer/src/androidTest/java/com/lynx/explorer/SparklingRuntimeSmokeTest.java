...
public class SparklingRuntimeSmokeTest {
  ...
  public void enabledVariantCreatesSparklingBridgeAndContainerGlobalProps() throws Throwable {
    ...
    Method buildMethod =
        sparklingClass.getMethod("build", Context.class, sparklingContextClass);
    ...
    assertEquals("homepage.lynx.bundle", schemeParam.getClass().getMethod("getBundle")
        .invoke(schemeParam));
    ...
    InstrumentationRegistry.getInstrumentation().runOnMainSync(() -> {
      try {
        ...
        assertTrue(sparklingView.getClass().getMethod("actualView").invoke(sparklingView)
            instanceof View);
    ...
    assertRouterOpenBridgeCallSucceeds(classLoader, sparklingContext, sparklingContextClass,
        containerId);
  }
  ...
  private static Map<String, Object> getSparklingGlobalProps(ClassLoader classLoader,
    ...
    return (Map<String, Object>) globalPropsUtilsClass
        .getMethod("getGlobalProps", String.class)
  ...
  private static void assertRouterOpenBridgeCallSucceeds(ClassLoader classLoader,
    ...
    data.putString(
        "scheme", "hybrid://lynxview_page?bundle=homepage.lynx.bundle&hide_loading=1&hide_nav_bar=1");
    ...
    Class<?> delegateClass =
        classLoader.loadClass("com.tiktok.sparkling.method.protocol.impl.lynx.RealLynxBridgeDelegate");
    Object delegate = delegateClass.getConstructor(Object.class).newInstance(bridgeContext);
    delegateClass.getMethod(
        "call", String.class, ReadableMap.class, Callback.class, String.class)
