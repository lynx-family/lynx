...
// same thread the animations live on).
class InspectorAnimationObserverImpl : public tasm::InspectorAnimationObserver {
 public:
  ...
  void OnAnimationStarted(animation::Animation* animation) override;
