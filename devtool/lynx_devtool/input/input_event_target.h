...
#ifndef DEVTOOL_LYNX_DEVTOOL_INPUT_INPUT_EVENT_TARGET_H_
#define DEVTOOL_LYNX_DEVTOOL_INPUT_INPUT_EVENT_TARGET_H_
...
#endif  // DEVTOOL_LYNX_DEVTOOL_INPUT_INPUT_EVENT_TARGET_H_
