...
static constexpr const char* const CLAY_VIEW_REGISTRY_HAS_PLATFORM_NATIVE_VIEW =
    "ViewRegistry::HasPlatformNativeView";
static constexpr const char* const
    CLAY_VIEW_REGISTRY_HAS_PLATFORM_NATIVE_VIEW_RESULT =
        "ViewRegistry::HasPlatformNativeViewResult";
