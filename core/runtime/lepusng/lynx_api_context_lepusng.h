...
#ifndef CORE_RUNTIME_LEPUSNG_LYNX_API_CONTEXT_LEPUSNG_H_
#define CORE_RUNTIME_LEPUSNG_LYNX_API_CONTEXT_LEPUSNG_H_
...
#endif  // CORE_RUNTIME_LEPUSNG_LYNX_API_CONTEXT_LEPUSNG_H_
