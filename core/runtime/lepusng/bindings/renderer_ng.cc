...
const runtime::RenderBindingFunction* Renderer::GetBuiltinFunctionsForFiber(
  ...
  constexpr const static runtime::RenderBindingFunction kFuncs[] = {
    ...
    /* 136 */ {kCFunctionSetComposeModifier, &RendererFunctions::FiberSetComposeModifier, true, true},
    /* 137 */ {kCFunctionCreateCompose, &RendererFunctions::FiberCreateCompose, true, true},
  };
  // clang-format on
  size = sizeof(kFuncs) / sizeof(kFuncs[0]);
  return kFuncs;
