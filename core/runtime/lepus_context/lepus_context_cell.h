...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_LEPUS_CONTEXT_CELL_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_LEPUS_CONTEXT_CELL_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_LEPUS_CONTEXT_CELL_H_
