...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_BASE_BINARY_READER_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_BASE_BINARY_READER_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_BASE_BINARY_READER_H_
