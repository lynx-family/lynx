...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_BINARY_INPUT_STREAM_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_BINARY_INPUT_STREAM_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_BINARY_INPUT_STREAM_H_
