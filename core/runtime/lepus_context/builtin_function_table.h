...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_BUILTIN_FUNCTION_TABLE_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_BUILTIN_FUNCTION_TABLE_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_BUILTIN_FUNCTION_TABLE_H_
