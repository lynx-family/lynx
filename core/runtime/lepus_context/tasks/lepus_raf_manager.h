...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_TASKS_LEPUS_RAF_MANAGER_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_TASKS_LEPUS_RAF_MANAGER_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_TASKS_LEPUS_RAF_MANAGER_H_
