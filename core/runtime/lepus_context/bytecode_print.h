...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_BYTECODE_PRINT_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_BYTECODE_PRINT_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_BYTECODE_PRINT_H_
