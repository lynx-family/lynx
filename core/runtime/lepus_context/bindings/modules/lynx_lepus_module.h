...
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_BINDINGS_MODULES_LYNX_LEPUS_MODULE_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_BINDINGS_MODULES_LYNX_LEPUS_MODULE_H_
#include <memory>
#include <string>
#include <utility>
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_BINDINGS_MODULES_LYNX_LEPUS_MODULE_H_
