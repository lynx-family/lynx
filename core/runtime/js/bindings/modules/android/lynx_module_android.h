...
#ifndef CORE_RUNTIME_JS_BINDINGS_MODULES_ANDROID_LYNX_MODULE_ANDROID_H_
#define CORE_RUNTIME_JS_BINDINGS_MODULES_ANDROID_LYNX_MODULE_ANDROID_H_
...
#include "core/runtime/js/bindings/modules/android/java_attribute_descriptor.h"
