...
piper::Value JsTaskAdapter::SetTimeout(piper::Function func, int32_t delay,
...
piper::Value JsTaskAdapter::SetInterval(piper::Function func, int32_t delay,
                                        uint64_t trace_flow_id) {
...
void JsTaskAdapter::QueueMicrotask(piper::Function func,
                                   uint64_t trace_flow_id) {
  auto task =
...
base::closure JsTaskAdapter::MakeTask(piper::Function func, TaskType task_type,
                                      uint64_t trace_flow_id) {
