...
#ifndef CORE_RUNTIME_LEPUS_BINDINGS_EVENT_CONTEXT_PROXY_IN_LEPUS_H_
#define CORE_RUNTIME_LEPUS_BINDINGS_EVENT_CONTEXT_PROXY_IN_LEPUS_H_
...
#endif  // CORE_RUNTIME_LEPUS_BINDINGS_EVENT_CONTEXT_PROXY_IN_LEPUS_H_
