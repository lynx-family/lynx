...
#ifndef CORE_RUNTIME_LEPUS_CODE_GENERATOR_H_
#define CORE_RUNTIME_LEPUS_CODE_GENERATOR_H_
...
class CodeGenerator : public Visitor {
 ...
 private:
  ...
  bool InstructionWritesToRegister(const Instruction& instr, long reg);
  friend ContextScope;
  friend BlockScope;
  friend LineScope;
};
...
#endif  // CORE_RUNTIME_LEPUS_CODE_GENERATOR_H_
