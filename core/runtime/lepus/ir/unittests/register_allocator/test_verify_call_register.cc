...
class VerifyCallRegisterTest : public IRTestBase {
 public:
...
TEST_F(VerifyCallRegisterTest, PassVerifiesCorrectAllocation) {
...
TEST_F(VerifyCallRegisterTest, PassFailsIncorrectAllocation) {
...
TEST_F(VerifyCallRegisterTest, PassSucceedsIfArgAlreadyInDestAndLive) {
...
TEST_F(VerifyCallRegisterTest, PassSucceedsIfLiveValueAboveClobberRange) {
...
TEST_F(VerifyCallRegisterTest, PassSucceedsIfMultipleArgsAlreadyInDestAndLive) {
...
TEST_F(VerifyCallRegisterTest, PassFailsIfToplevelVarInClobberRange) {
...
TEST_F(VerifyCallRegisterTest, PassFailsIfParamInClobberRange) {
...
TEST_F(VerifyCallRegisterTest, PassSucceedsIfParamIsArgAndAlreadyInDest) {
