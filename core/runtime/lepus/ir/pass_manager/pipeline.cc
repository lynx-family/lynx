...
//
//   - Function::upvalue_index_to_toplevel_reg_
//       Data:  runtime mapping (upvalue index -> toplevel physical reg)
...
//       Updates:  Function::upvalue_index_to_toplevel_reg_ runtime mapping
//
