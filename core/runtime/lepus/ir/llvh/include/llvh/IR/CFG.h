...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_IR_CFG_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_IR_CFG_H_
...
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/iterator.h"
...
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/type_traits.h"
...
// }
// inline pred_iterator pred_end(BasicBlock *BB) { return pred_iterator(BB,
// true);} inline const_pred_iterator pred_end(const BasicBlock *BB) {
...
// using succ_const_iterator = SuccIterator<const Instruction, const
// BasicBlock>; using succ_range = iterator_range<succ_iterator>; using
// succ_const_range = iterator_range<succ_const_iterator>;
...
// }
// inline succ_iterator succ_end(Instruction *I) { return succ_iterator(I,
// true); } inline succ_const_iterator succ_end(const Instruction *I) {
...
//   static NodeRef getEntryNode(Inverse<const BasicBlock *> G) { return
//   G.Graph; } static ChildIteratorType child_begin(NodeRef N) { return
//   pred_begin(N); } static ChildIteratorType child_end(NodeRef N) { return
//   pred_end(N); }
// };
...
//   static NodeRef getEntryNode(const Function *F) { return
//   &F->getEntryBlock(); }
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_IR_CFG_H_
