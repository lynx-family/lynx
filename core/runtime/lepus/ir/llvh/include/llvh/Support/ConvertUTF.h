...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_CONVERTUTF_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_CONVERTUTF_H_

#include <cstddef>
#include <string>
#include <system_error>

// Wrap everything in namespace llvh so that programs can link with llvm and
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_CONVERTUTF_H_
