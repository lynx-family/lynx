...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_ALLOCATOR_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_ALLOCATOR_H_
...
class BumpPtrAllocatorImpl
 ...
 public:
  ...
  size_t getTotalMemory() const {
    ...
    for (auto& PtrAndSize : CustomSizedSlabs) TotalMemory += PtrAndSize.second;
    return TotalMemory;
  }
...
void* operator new(size_t Size,
                   llvh::BumpPtrAllocatorImpl<AllocatorT, SlabSize,
...
void operator delete(
    void*, llvh::BumpPtrAllocatorImpl<AllocatorT, SlabSize, SizeThreshold>&) {}

#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_ALLOCATOR_H_
