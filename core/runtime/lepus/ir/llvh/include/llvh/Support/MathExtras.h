...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_MATHEXTRAS_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_MATHEXTRAS_H_
...
std::size_t countTrailingZeros(T Val, ZeroBehavior ZB = ZB_Width) {
  static_assert(
      ...
      "Only unsigned integral types are allowed.");
  return llvh::detail::TrailingZerosCounter<T, sizeof(T)>::count(Val, ZB);
}
...
std::size_t countLeadingZeros(T Val, ZeroBehavior ZB = ZB_Width) {
  static_assert(
      std::numeric_limits<T>::is_integer && !std::numeric_limits<T>::is_signed,
      "Only unsigned integral types are allowed.");
  return llvh::detail::LeadingZerosCounter<T, sizeof(T)>::count(Val, ZB);
}
...
/// This function takes a int64 and returns the bit equivalent 64-bit integer.
inline uint64_t Int64ToBits(int64_t Int64) {
  uint64_t Bits;
  memcpy(&Bits, &Int64, sizeof(Int64));
  return Bits;
}
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_MATHEXTRAS_H_
