...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_TYPE_TRAITS_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_TYPE_TRAITS_H_
...
struct is_trivially_copy_constructible
    : std::is_copy_constructible<
          ::llvh::detail::copy_construction_triviality_helper<T>> {};
template <typename T>
...
struct is_trivially_move_constructible
    : std::is_move_constructible<
          ::llvh::detail::move_construction_triviality_helper<T>> {};
template <typename T>
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_TYPE_TRAITS_H_
