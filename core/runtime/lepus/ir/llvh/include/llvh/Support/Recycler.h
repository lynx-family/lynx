...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_RECYCLER_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_RECYCLER_H_
...
void Recycler<T, Size, Align>::PrintStats() {
  size_t S = 0;
  for (auto* I = FreeList; I; I = I->Next) ++S;
  PrintRecyclerStats(Size, Align, S);
}

}  // namespace llvh

#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_SUPPORT_RECYCLER_H_
