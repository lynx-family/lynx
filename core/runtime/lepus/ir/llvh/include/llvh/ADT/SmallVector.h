...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_SMALLVECTOR_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_SMALLVECTOR_H_
...
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/MemAlloc.h"
...
void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
  ...
  if (NewCapacity <= this->capacity() || NewCapacity < MinSize ||
...
template <typename T>
inline void swap(llvh::SmallVectorImpl<T>& LHS, llvh::SmallVectorImpl<T>& RHS) {
  LHS.swap(RHS);
}

/// Implement std::swap in terms of SmallVector swap.
template <typename T, unsigned N>
inline void swap(llvh::SmallVector<T, N>& LHS, llvh::SmallVector<T, N>& RHS) {
  LHS.swap(RHS);
}

}  // end namespace std

#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_SMALLVECTOR_H_
