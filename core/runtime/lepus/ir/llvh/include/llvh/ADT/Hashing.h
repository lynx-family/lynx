...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_HASHING_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_HASHING_H_
...
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/DataTypes.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/Host.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/SwapByteOrder.h"
...
hash_code hash_value(const std::vector<T, Allocator>& arg);
...
struct MakeUnsignedConstantIndexSet {
  typedef
      typename MakeUnsignedConstantIndexSet<I + 1, N, Indices..., I>::Type Type;
};
...
hash_code hash_value_tuple_helper(
...
hash_code hash_value(const std::tuple<Ts...>& arg) {
  return hash_value_tuple_helper(
      arg, typename MakeUnsignedConstantIndexSet<0, sizeof...(Ts)>::Type());
}
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_HASHING_H_
