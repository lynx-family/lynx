...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_FOLDINGSET_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_FOLDINGSET_H_
...
template <typename T>
inline unsigned DefaultFoldingSetTrait<T>::ComputeHash(
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_FOLDINGSET_H_
