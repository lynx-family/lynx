...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_ITERATOR_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_ITERATOR_H_
...
template <>
struct IteratorHelper<false> : ilist_detail::NodeAccess {
...
template <>
struct IteratorHelper<true> : ilist_detail::NodeAccess {
  using Access = ilist_detail::NodeAccess;
...
class ilist_iterator : ilist_detail::SpecificNodeAccess<OptionsT> {
 ...
 public:
  ...
  ilist_iterator<OptionsT, !IsReverse, IsConst> getReverse() const {
    if (NodePtr) return ilist_iterator<OptionsT, !IsReverse, IsConst>(*NodePtr);
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_ITERATOR_H_
