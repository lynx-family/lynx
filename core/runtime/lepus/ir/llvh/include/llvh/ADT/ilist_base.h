...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_BASE_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_BASE_H_
...
class ilist_base {
 public:
  ...
  static void transferBeforeImpl(node_base_type& Next, node_base_type& First,
                                 node_base_type& Last) {
    if (&Next == &Last || &First == &Last) return;
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_BASE_H_
