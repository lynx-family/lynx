...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_DENSEMAP_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_DENSEMAP_H_
...
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/DenseMapInfo.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/EpochTracker.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/AlignOf.h"
...
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/ReverseIteration.h"
...
class DenseMapIterator : DebugEpochBase::HandleBase {
 ...
 public:
  ...
  reference operator*() const {
    ...
    if (shouldReverseIterate<KeyT>()) return Ptr[-1];
    return *Ptr;
  }
  ...
  bool operator!=(const NonConstIterator& RHS) const { return !(*this == RHS); }
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_DENSEMAP_H_
