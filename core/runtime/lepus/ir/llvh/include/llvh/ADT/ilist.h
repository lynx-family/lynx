...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_H_
...
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/simple_ilist.h"
...
class iplist_impl : public TraitsT, IntrusiveListT {
 ...
 public:
  ...
  void splice(iterator where, iplist_impl& L2) {
    if (!L2.empty()) transfer(where, L2, L2.begin(), L2.end());
  }
...
template <class Ty>
void swap(llvh::iplist<Ty>& Left, llvh::iplist<Ty>& Right) {
  Left.swap(Right);
}

}  // end namespace std

#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_H_
