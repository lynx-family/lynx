...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_NODE_OPTIONS_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_NODE_OPTIONS_H_
...
/// the ABI depends on LLVH_ENABLE_ABI_BREAKING_CHECKS.  Specify explicitly to
...
template <>
struct extract_sentinel_tracking<> : std::true_type, is_implicit {};
#else
template <>
...
template <class Tag>
struct is_valid_option<ilist_tag<Tag>> : std::true_type {};
...
template <>
struct check_options<> : std::true_type {};
template <class Option1, class... Options>
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_NODE_OPTIONS_H_
