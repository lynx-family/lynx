...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_GRAPHTRAITS_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_GRAPHTRAITS_H_
...
template <class GraphType>
iterator_range<typename GraphTraits<GraphType>::nodes_iterator> nodes(
    const GraphType& G) {
...
template <class GraphType>
iterator_range<typename GraphTraits<GraphType>::ChildIteratorType> children(
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_GRAPHTRAITS_H_
