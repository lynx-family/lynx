...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_DEPTHFIRSTITERATOR_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_DEPTHFIRSTITERATOR_H_
 ...
 private:
  ...
  inline void toNext() {
    do {
      ...
      if (!Opt) Opt.emplace(GT::child_begin(Node));
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_DEPTHFIRSTITERATOR_H_
