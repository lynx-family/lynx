...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_NODE_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_NODE_H_

#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/ilist_node_base.h"
...
template <class OptionsT>
class ilist_node_impl : OptionsT::node_base_type {
...
/// LLVH_ENABLE_ABI_BREAKING_CHECKS.  The function \a isKnownSentinel() always
...
struct NodeAccess {
 protected:
  ...
  template <class OptionsT>
  static const ilist_node_impl<OptionsT>* getNodePtr(
  ...
  template <class OptionsT>
  static typename OptionsT::const_pointer getValuePtr(
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_INCLUDE_LLVH_ADT_ILIST_NODE_H_
