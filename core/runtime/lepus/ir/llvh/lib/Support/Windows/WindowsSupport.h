...
#ifndef CORE_RUNTIME_LEPUS_IR_LLVH_LIB_SUPPORT_WINDOWS_WINDOWSSUPPORT_H_
#define CORE_RUNTIME_LEPUS_IR_LLVH_LIB_SUPPORT_WINDOWS_WINDOWSSUPPORT_H_
...
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/StringExtras.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/StringRef.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/ADT/Twine.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/Chrono.h"
#include "core/runtime/lepus/ir/llvh/include/llvh/Support/Compiler.h"
#include "llvh/Config/llvh-config.h"  // Get build system configuration settings
...
class ScopedHandle {
 ...
 public:
  ...
  ~ScopedHandle() {
    if (HandleTraits::IsValid(Handle)) HandleTraits::Close(Handle);
  }
...
#endif  // CORE_RUNTIME_LEPUS_IR_LLVH_LIB_SUPPORT_WINDOWS_WINDOWSSUPPORT_H_
