...
#ifndef CORE_RUNTIME_COMMON_BINDINGS_MODULES_MOCK_NATIVE_MODULE_H_
#define CORE_RUNTIME_COMMON_BINDINGS_MODULES_MOCK_NATIVE_MODULE_H_
...
#endif  // CORE_RUNTIME_COMMON_BINDINGS_MODULES_MOCK_NATIVE_MODULE_H_
