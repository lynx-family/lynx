...
#ifndef CORE_RUNTIME_BINDINGS_LEPUS_STYLE_SHARED_CSS_FRAGMENT_WRAPPER_H_
#define CORE_RUNTIME_BINDINGS_LEPUS_STYLE_SHARED_CSS_FRAGMENT_WRAPPER_H_
...
#endif  // CORE_RUNTIME_BINDINGS_LEPUS_STYLE_SHARED_CSS_FRAGMENT_WRAPPER_H_
