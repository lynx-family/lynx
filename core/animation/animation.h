...
class Animation : public std::enable_shared_from_this<Animation> {
 ...
 private:
  friend class CSSKeyframeManager;
  friend class CSSTransitionManager;
  ...
  // Token obtained from playback_ when execution switches between New Animator
  // and the platform; carried by commands and used to reject stale events.
  ...
  gfx::AnimationPlaybackState::EventState event_state_{
      gfx::AnimationPlaybackState::EventState::kNotStarted};
