...
class TextLayoutHarmony final : public TextLayoutImpl {
 public:
  explicit TextLayoutHarmony(TextLayoutManagerHarmony* text_layout_manager)
      : text_layout_manager_(text_layout_manager) {}
 ...
 private:
  TextLayoutManagerHarmony* text_layout_manager_{nullptr};
};
