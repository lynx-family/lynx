...
Java_com_lynx_tasm_behavior_render_PlatformRendererContext_nativeGetDisplayListLengths(
    JNIEnv* env, jobject jcaller, jint id) {
...
Java_com_lynx_tasm_behavior_render_PlatformRendererContext_nativeGetDisplayListData(
    JNIEnv* env, jobject jcaller, jint id, jintArray ops, jintArray iArgv,
    jfloatArray fArgv) {
