...
#ifndef CORE_RENDERER_UI_WRAPPER_PAINTING_HARMONY_PAINT_IMAGE_HARMONY_H_
#define CORE_RENDERER_UI_WRAPPER_PAINTING_HARMONY_PAINT_IMAGE_HARMONY_H_
...
#endif  // CORE_RENDERER_UI_WRAPPER_PAINTING_HARMONY_PAINT_IMAGE_HARMONY_H_
