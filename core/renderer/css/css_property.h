...
#define ALL_ANIMATABLE_PROPERTY_ID                                          \
  tasm::kPropertyIDTop, tasm::kPropertyIDLeft, tasm::kPropertyIDRight,      \
      ...
      tasm::kPropertyIDBoxShadow, tasm::kPropertyIDBorderTopLeftRadius,     \
...
#define FOREACH_NEW_ANIMATOR_PROPERTY(V)                          \
  ...
  V(kPropertyIDBorderTopLeftRadius, kBorderTopLeftRadius)         \
  V(kPropertyIDBorderTopRightRadius, kBorderTopRightRadius)       \
  V(kPropertyIDBorderBottomRightRadius, kBorderBottomRightRadius) \
  V(kPropertyIDBorderBottomLeftRadius, kBorderBottomLeftRadius)
