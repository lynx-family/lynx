...
void FiberElement::RemoveAllInlineStyles() {
  ...
  // Here we clear the css_variables_from_js_, it will be
  // inserted again in next ProcessFullRawInlineStyle.
  // data_model()->ClearCSSInlineVariables();
      ...
      [this, changed_css_vars, &configs](
        ...
        if (CSSProperty::IsPropertyValid(id)) {
          ...
          data_model()->UpdateCSSInlineVariables(
              ...
              base::String(value_start, value_length), changed_css_vars);
        }
