...
bool TemplateEntry::ConstructContext(TemplateAssembler* assembler,
                                     ...
                                     bool disable_tracing_gc, bool debuggable) {
  ...
  if (!vm_context_) {
    ...
    vm_context_ = lepus::Context::CreateContext(
        is_lepusng_binary, disable_tracing_gc, mode, debuggable);
  }
...
bool TemplateEntry::InitWithTemplateBundle(
    ...
    LynxTemplateBundle template_bundle, bool debuggable) {
...
bool TemplateEntry::InitLepusContext(
  ...
  if (!ConstructContext(tasm, template_bundle().is_lepusng_binary(),
                        *template_bundle().context_bundle_,
                        ...
                        page_config->GetDisableQuickTracingGC(), debuggable)) {
