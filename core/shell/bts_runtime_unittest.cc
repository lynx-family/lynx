...
using runtime::js::App;
using runtime::js::Function;
using runtime::js::HostObject;
using runtime::js::LynxModuleManager;
using runtime::js::Object;
using runtime::js::PropNameID;
using runtime::js::Runtime;
using runtime::js::Value;
using runtime::js::test::JSITestBase;
using runtime::js::test::MockModuleDelegate;
...
class RecordingLoadCardApp : public HostObject {
 public:
  Value get(Runtime* rt, const PropNameID& name) override {
    ...
    return Function::createFromHostFunction(
        *rt, PropNameID::forAscii(*rt, "loadCard"), 1,
  ...
  std::vector<PropNameID> getPropertyNames(Runtime& rt) override {
    return {PropNameID::forUtf8(rt, "loadCard")};
  }
...
class BTSRuntimeTest : public JSITestBase {
 public:
 ...
 protected:
  void SetUp() override {
    ...
    auto native_module_proxy =
        Object::createFromHostObject(*runtime, module_manager_->bindingPtr);
    ...
    app_->setJsAppObj(Object::createFromHostObject(*runtime, js_app_));

    auto load_card_func = Value(
        *runtime,
        js_app_->get(runtime.get(), PropNameID::forAscii(*runtime, "loadCard"))
            .getObject(*runtime));
...
INSTANTIATE_TEST_SUITE_P(
    BTSRuntimeTests, BTSRuntimeTest,
