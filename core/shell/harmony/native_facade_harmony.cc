...
void NativeFacadeHarmony::OnShouldSendEventToMainThreadChanged(bool enable) {
  renderer_->OnShouldSendEventToMainThreadChanged(enable);
}
...
void NativeFacadeHarmony::FlushJSBTiming(runtime::js::NativeModuleInfo timing) {
}
...
void NativeFacadeHarmony::StartRecording(const lepus::Value& value) {}

void NativeFacadeHarmony::StopRecording(const lepus::Value& value) {}
