...
#ifndef CORE_SERVICES_EVENT_REPORT_GENERIC_INFO_STORAGE_H_
#define CORE_SERVICES_EVENT_REPORT_GENERIC_INFO_STORAGE_H_
...
class GenericInfo {
 public:
  ...
  std::unique_ptr<pub::Value> GetGenericInfo();

 private:
  void MarkDirty(bool dirty) { is_dirty = dirty; };
...
class GenericInfoStorage {
 public:
  ...
  void GetAllGenericInfosInReportThread(
      int32_t instance_id,
...
#endif  // CORE_SERVICES_EVENT_REPORT_GENERIC_INFO_STORAGE_H_
