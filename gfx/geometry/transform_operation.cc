...
bool TransformOperation::BlendTransformOperations(
  ...
  switch (operation.type) {
    case Type::kTranslate: {
      ...
      const float from_z = TranslateValue(
          from, &TransformOperation::Translate::z, 0.0f, LengthUnit::kNumber);
      const float to_z = TranslateValue(to, &TransformOperation::Translate::z,
                                        0.0f, LengthUnit::kNumber);
