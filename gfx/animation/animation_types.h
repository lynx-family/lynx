...
// TODO: Make starlight and Clay reuse this enum as the single definition,
// optionally through type aliases. Preserve existing numeric values and migrate
// required legacy values (such as kLegacyAll_1/2/3) before removing their
// enums.
