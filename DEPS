...
deps = {
    ...
    "python_venv_set": {
        ...
        "commands": [
            python_path
            + " tools/vpython_tools/vpython_env_setup.py --root_dir "
            + root_dir,
        ],
    },
    ...
    "update_gradle_local_properties": {
        ...
        "commands": [
            f"{python_path} "
            + os.path.join(
                root_dir, "tools", "android_tools", "update_local_properties.py"
            )
            + " "
            "-f "
    ...
    "third_party/perfetto": {
        ...
        "patches": [os.path.join(root_dir, "patches", "perfetto", "*.patch")],
        "ignore_in_git": True,
        "paths": ["sdk"],
    },
    ...
    "third_party/quickjs/src": {
        ...
        "commit": "b0a730a060ea8697f11dca6c5b0551c8dfd8bb3e",
        "ignore_in_git": True,
    },
    ...
    "third_party/boringssl": {
        ...
        "patches": [os.path.join(root_dir, "patches", "boringssl", "*.patch")],
        "ignore_in_git": True,
    },
    ...
    "setup_corepack_pnpm": {
        ...
        "env": {
            ...
            "PATH": (
                f"{os.path.join(root_dir, 'buildtools', 'node')};{os.environ.get('PATH')}"
                if system == "windows"
    ...
    "gen_lynx_perfromance_entry": {
        ...
        "commands": [
            python_path
            + " tools/performance/performance_observer/generate_performance_entry.py",
        ],
    },
