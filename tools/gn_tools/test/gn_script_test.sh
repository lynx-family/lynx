...
# generate cmake 
vpython3 tools_shared/gn_tools/gn_wrapper.py gen out/gn_cmake_test --args="enable_unittests=true use_flutter_cxx=false" --ide=cmake --cmake-target="//lynx/tools/gn_tools/test:cmake_test"
# generate podspec 
vpython3 tools_shared/gn_tools/gn_wrapper.py gen out/gn_podspec_test --args="enable_unittests=true use_flutter_cxx=false" --ide=podspec --podspec-target="//lynx/tools/gn_tools/test:podspec_test"
