...
export type CSSProperties = Modify<
  CSS.Properties<string | number>,
  {
    ...
    display?: 'none' | 'flex' | 'grid' | 'linear' | 'relative' | 'block' | '-x-box' | 'auto';
    XBoxPropagateMinConstraints?: 'true' | 'false';
    XBoxMatchParentSize?: 'true' | 'false';
