...
describe('Test Pointer Events', () => {
  it('pointer events have no nested detail', () => {
    expectTypeOf<PointerEvent>().not.toHaveProperty('detail');
    expectTypeOf<MainThread.PointerEvent>().not.toHaveProperty('detail');
  });
