...
## CI Checks & Running Locally

See [CONTRIBUTING.md](https://github.com/lynx-family/lynx/blob/develop/CONTRIBUTING.md#static-code-analysis-tasks) for the full list of CI checks and how to run them locally.
