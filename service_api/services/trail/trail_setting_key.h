...
struct SettingValueTraits {
  ...
  static return_type FromStringValue(const std::optional<std::string>&,
                                     const return_type&) {
    static_assert(detail::AlwaysFalse<ValueType>::value,
...
struct SettingValueTraits<bool, HasDefault> {
  ...
  static return_type FromStringValue(
    ...
    return detail::ConvertToBool(*string_result);
  }
};
...
struct SettingValueTraits<long, HasDefault> {
  ...
  static return_type FromStringValue(
      const std::optional<std::string>& string_result,
      return_type default_value) {
    return detail::ConvertToLong(string_result, default_value);
  }
};
...
#ifdef LYNX_TRAIL_SERVICE_IMPL
#define _LYNX_SETTING_KEY_WITHOUT_DEFAULT(var, value_type, key_str) \
  EXPORT_VAR extern const SettingKey<value_type, false> var(key_str)
#define _LYNX_SETTING_KEY_WITH_DEFAULT(var, value_type, key_str,    \
                                       default_value)               \
  EXPORT_VAR extern const SettingKey<value_type, true> var(key_str, \
                                                           default_value)
#else
#define _LYNX_SETTING_KEY_WITHOUT_DEFAULT(var, value_type, key_str) \
  extern const SettingKey<value_type, false> var
#define _LYNX_SETTING_KEY_WITH_DEFAULT(var, value_type, key_str, \
                                       default_value)            \
  extern const SettingKey<value_type, true> var
#endif
