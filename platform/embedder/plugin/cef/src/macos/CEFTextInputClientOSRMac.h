...
#ifndef PLATFORM_EMBEDDER_PLUGIN_CEF_SRC_MACOS_CEFTEXTINPUTCLIENTOSRMAC_H_
#define PLATFORM_EMBEDDER_PLUGIN_CEF_SRC_MACOS_CEFTEXTINPUTCLIENTOSRMAC_H_
#pragma once
...
@interface CefTextInputClientOSRMac : NSView <NSTextInputClient> {
 @private
...
#endif  // PLATFORM_EMBEDDER_PLUGIN_CEF_SRC_MACOS_CEFTEXTINPUTCLIENTOSRMAC_H_
