...
public class PlatformRendererContext implements TextMeasurerProvider {
  ...
  ByteBuffer getDisplayListItemsBuffer(int id) {
    ...
    return makeReadOnlyDisplayListBuffer(nativeGetDisplayListItemsBuffer(mNativePtr, id));
  }
  ...
  private native ByteBuffer nativeGetDisplayListItemsBuffer(long nativePtr, int id);
