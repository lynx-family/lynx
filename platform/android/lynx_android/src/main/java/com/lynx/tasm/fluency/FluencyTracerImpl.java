...
class FluencyTracerImpl {
  ...
  public void start(int sign, FluencyTracerConfig config) {
    ...
    if (TraceEvent.enableTrace()) {
      ...
      TraceEvent.instant(TraceEvent.CATEGORY_VITALS, "ScrollStart", props);
    }
  }
  ...
  public void stop(int sign) {
    ...
    if (TraceEvent.enableTrace()) {
      Map<String, String> props = new HashMap<>();
      props.put("sign", String.valueOf(sign));
      TraceEvent.instant(TraceEvent.CATEGORY_VITALS, "ScrollStop", props);
    }
  }
