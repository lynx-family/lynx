...
export class UIFrame {
  ...
  attachChildUIOwner(childOwner: UIOwner): void;
...
export class ExtensionModule {
  ...
  nativeAddDownStreamSurface(
    ...
    scaleMode: number, hasSourceRect: boolean, sourceX: number, sourceY: number,
    sourceWidth: number, sourceHeight: number, maxFPS: number
  ): bigint | undefined;
