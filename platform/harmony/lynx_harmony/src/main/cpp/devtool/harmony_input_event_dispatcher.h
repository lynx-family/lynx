...
#ifndef PLATFORM_HARMONY_LYNX_HARMONY_SRC_MAIN_CPP_DEVTOOL_HARMONY_INPUT_EVENT_DISPATCHER_H_
#define PLATFORM_HARMONY_LYNX_HARMONY_SRC_MAIN_CPP_DEVTOOL_HARMONY_INPUT_EVENT_DISPATCHER_H_
...
class HarmonyInputEventDispatcher {
 public:
  HarmonyInputEventDispatcher();
  ~HarmonyInputEventDispatcher();

  bool InjectPointerEvent(const std::shared_ptr<LynxContext>& context,
                          const input::PointerEvent& event);
  void WaitForInputProcessed(const std::shared_ptr<LynxContext>& context,
                             std::function<void(bool)> callback);
  void Shutdown(const std::shared_ptr<LynxContext>& context);
...
#endif  // PLATFORM_HARMONY_LYNX_HARMONY_SRC_MAIN_CPP_DEVTOOL_HARMONY_INPUT_EVENT_DISPATCHER_H_
