...
#include "lynx/core/public/lynx_extension_delegate.h"
...
class LynxContext {
 public:
  ...
  void SetUseHarmonyNewOverlay(bool use_new_overlay);

  bool GetUseHarmonyNewOverlay() { return use_harmony_new_overlay_; }
 ...
 private:
  ...
  bool use_harmony_new_overlay_{true};
