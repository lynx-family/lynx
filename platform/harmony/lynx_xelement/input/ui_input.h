...
#ifndef PLATFORM_HARMONY_LYNX_XELEMENT_INPUT_UI_INPUT_H_
#define PLATFORM_HARMONY_LYNX_XELEMENT_INPUT_UI_INPUT_H_
...
class UIInput : public UIBaseInput {
 public:
  static UIBase* Make(LynxContext* context, int sign, const std::string& tag);
  static ArkUI_TextInputType ParseInputType(const lepus::Value& value);
  void OnPropUpdate(const std::string& name,
                    const lepus::Value& value) override;

 protected:
  UIInput(LynxContext* context, ArkUI_NodeType type, int sign,
  ...
  ArkUI_NodeAttributeType GetCaretAttributeType() const override;
...
#endif  // PLATFORM_HARMONY_LYNX_XELEMENT_INPUT_UI_INPUT_H_
