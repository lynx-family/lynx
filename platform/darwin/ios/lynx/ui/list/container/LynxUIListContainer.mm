  ...
  if (stickyStartItem) {
    if (self.prevStickyStartItem != stickyStartItem) {
      if (self.verticalOrientation) {
        ...
        [self.scrollEventManager sendScrollEvent:LynxEventStickyLeft
                                      scrollView:self.view
                                          detail:@{
                                            @"left" : ((LynxUIComponent *)stickyStartItem).itemKey,
                                          }];
      }
  ...
  if (stickyEndItem) {
    if (self.prevStickyEndItem != stickyEndItem) {
      if (self.verticalOrientation) {
        ...
        [self.scrollEventManager sendScrollEvent:LynxEventStickyRight
                                      scrollView:self.view
                                          detail:@{
                                            @"right" : ((LynxUIComponent *)stickyEndItem).itemKey,
                                          }];
      }
