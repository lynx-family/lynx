...
@interface LynxPanGestureHandlerUnitTest : XCTestCase

@end

@interface LynxPanGestureHandlerUnitTest () <LynxGestureArenaMember>

@end

@implementation LynxPanGestureHandlerUnitTest
...
- (void)testMask {
  LynxPanGestureHandler *handler = [[LynxPanGestureHandler alloc]
      initWithSign:1
          ...
          detector:[[LynxGestureDetectorDarwin alloc]
                       ...
                       gestureCallbackNames:@[
                         ...
                         ON_BEGIN, ON_UPDATE, ON_END
                                ...
                                relationMap:@{}]];
  XCTAssertTrue([handler isGestureTypeMatched:LynxGestureHandlerOptionPan]);
...
#pragma clang diagnostic ignored "-Wnonnull"
  ...
  [handler begin:LynxGestureHandlerOptionPan
           point:CGPointZero
         touches:nil
           event:nil
      touchEvent:nil];
  [handler update:LynxGestureHandlerOptionPan
            point:CGPointZero
          touches:nil
            event:nil
       touchEvent:nil];
  [handler end:LynxGestureHandlerOptionPan point:CGPointZero touches:nil event:nil touchEvent:nil];
