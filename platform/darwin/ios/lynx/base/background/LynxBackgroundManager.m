...
- (void)applyEffect:(BOOL)forceRedraw {
  ...
  // Masks compose with native rounded painting; their presence does not change radius eligibility.
  ...
  // Native-radius eligibility can change after a size update without changing border
  // properties. Reconcile both the border layer's presence and renderer type before reusing it.
