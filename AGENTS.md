...
For Harmony XElement work, also consult [`agents/harmony_xelement.md`](./agents/harmony_xelement.md), especially the native C++ registration direction for `x-markdown`.
